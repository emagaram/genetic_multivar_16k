...
def calculate_kb_score(
    ...
    if kb not in scores_cache:
        ...
        score += constants.INACCURACY_WEIGHT * acc
        ...
        score += constants.REDIRECT_WEIGHT * redirect_sum
        ...
        score += constants.DISCOMFORT_WEIGHT * hind_sum
        score += constants.SFB_WEIGHT * sfb_sum
        ff_sum = (
            finger_freq_evaluator.evaluate_finger_frequencies(
        ...
        score += constants.FINGER_FREQ_WEIGHT * ff_sum
        scores_cache[kb] = {
            "score": score,
            "ffs": ff_sum,
            "acc": acc,
